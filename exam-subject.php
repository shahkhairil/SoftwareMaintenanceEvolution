...
$examname=$_POST['Exam'];
$status=1;
$sql="INSERT INTO  tblexam(ExamName) VALUES(:examname)";
...
<div class="col-sm-10">
<input type="text" name="Exam" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
